...
init_browser_polyfill();
$1;
var { annoProjectName } = await browser.storage.sync.get(initialStorageValues);
var annoProjectNameInputElement = document.querySelector(
...
annoProjectNameInputElement.addEventListener(
  "input",
